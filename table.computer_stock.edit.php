    ...
    )
    {
        ...
        )
        {
            ...
            if($result)
            {
                ...
                if($rows_affected)
                {
                    // header('Location: table.add_success.php');
...
<!--HEADER/NAVBAR-->
    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="column is-4-desktop is-offset-4-desktop is-10-mobile is-offset-1-mobile is-10-touch is-offset-1-touch">
                <div class="notification is-warning">
                    <strong>Error: </strong>You need to be logged in to update.<br>
                    <a href="./accounts.signin.php">Sign in</a> to update record details.
                </div>
            </div>
